...
class Widget_Factory_Set(object):
    def setupUi(self, Form):
        ...
        self.cb_agentRoom = QtWidgets.QComboBox(self.groupBox_2)
        self.cb_agentRoom.setMinimumSize(QtCore.QSize(150, 0))
        self.cb_agentRoom.setObjectName("cb_agentRoom")
        self.horizontalLayout_11.addWidget(self.cb_agentRoom)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_8.setText(_translate("Form", "代表室："))
