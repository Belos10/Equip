...
class EquipmentBalanceSelectUI(object):
    def setupUi(self, Form):
        ...
        self.pb_return.setMaximumSize(QtCore.QSize(100, 100))
        self.pb_return.setObjectName("pb_return")
        self.gridLayout_2.addWidget(self.pb_return, 1, 5, 1, 1)
        ...
        self.pb_sava.setMaximumSize(QtCore.QSize(100, 100))
        self.pb_sava.setObjectName("pb_sava")
        self.gridLayout_2.addWidget(self.pb_sava, 1, 3, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem1, 1, 2, 1, 1)
        spacerItem2 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem2, 1, 6, 1, 1)
        self.pb_alter = QtWidgets.QPushButton(Form)
        self.pb_alter.setObjectName("pb_alter")
        self.gridLayout_2.addWidget(self.pb_alter, 1, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.pb_alter.setText(_translate("Form", "修改"))
