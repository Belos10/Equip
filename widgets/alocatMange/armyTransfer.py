...
class Widget_Army_Transfer(object):
    def setupUi(self, Form):
        ...
        self.cb_rowNum = QtWidgets.QComboBox(self.groupBox_2)
        self.cb_rowNum.setObjectName("cb_rowNum")
        self.gridLayout.addWidget(self.cb_rowNum, 0, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.pb_output, 1, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.pb_update, 0, 3, 1, 2)
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "联系电话"))
        item = self.tw_result.item(1, 14)
        item.setText(_translate("Form", "装备名称"))
        item = self.tw_result.item(1, 15)
        ...
        self.label_2.setText(_translate("Form", "修改序号："))
