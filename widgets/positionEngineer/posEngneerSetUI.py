...
# Form implementation generated from reading ui file 'posEngneerSetUI.ui'
#
...
class PosEngneerSetUI(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(1018, 602)
        ...
        self.cb_equipType.addItem("")
        self.cb_equipType.addItem("")
        self.gridLayout_2.addWidget(self.cb_equipType, 1, 6, 1, 1)
        ...
        self.gridLayout_2.addLayout(self.horizontalLayout_4, 0, 7, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lb_equipType, 0, 6, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pb_add, 1, 7, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.cb_equipType.setItemText(1, _translate("Form", "x生化装备"))
        self.cb_equipType.setItemText(2, _translate("Form", "防护装备"))
