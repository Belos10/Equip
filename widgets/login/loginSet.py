...
class Widget_LoginSet(object):
    def setupUi(self, Form):
        ...
        self.tw_userInfo.setGeometry(QtCore.QRect(12, 27, 256, 192))
        ...
        self.gridLayout_2.addWidget(self.pb_add, 1, 8, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.le_pswd, 0, 9, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.pb_update, 1, 10, 1, 1)
        ...
        self.pb_restore = QtWidgets.QPushButton(self.groupBox_2)
        self.pb_restore.setObjectName("pb_restore")
        self.gridLayout_2.addWidget(self.pb_restore, 1, 12, 1, 1)
        self.pb_backUp = QtWidgets.QPushButton(self.groupBox_2)
        self.pb_backUp.setObjectName("pb_backUp")
        self.gridLayout_2.addWidget(self.pb_backUp, 0, 12, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.pb_restore.setText(_translate("Form", "恢复"))
        self.pb_backUp.setText(_translate("Form", "备份"))
