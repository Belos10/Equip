...
class yearServiceSupport(QDialog, Widget_ServiceSupport):
    ...
    #         将新增的数据存入数据库
    # '''
    # def saveContentOfserviceSupport(self):
    #     currentRow = self.serviceSupportResult.currentRow()
    #     currentCloumnCount = self.serviceSupportResult.columnCount()
    #     # print(currentRow)
    #     # print(currentCloumnCount)
    #     list = []
    #     # print(currentRow)
    #     if currentRow == -1:
    #         QMessageBox.warning(self, "注意", "请选中有效单元格！", QMessageBox.Yes, QMessageBox.Yes)
    #         return
    #     else:
    #         for i in range(currentCloumnCount):
    #             # print(i)
    #             if i == 1 or i == 8 or i == 9 or i == 10:
    #                 item = self.serviceSupportResult.cellWidget(currentRow, i).currentText()
    #                 # list.insert(i, item)
    #                 list.append(item)
    #             else:
    #                 item = self.serviceSupportResult.item(currentRow, i).text()
    #                 # list.insert(i, item)
    #                 list.append(item)
    #     data = list
    #     insertContentOfServiceSupport(data)

    # '''
    #     功能：
    #         更新有改变的数据到数据库
    # '''
    # def updateChangeDataOfServiceSupport(self):
    #     currentRow = self.serviceSupportResult.currentRow()   #当前选择数据的所在行的行数
    #     currentCloumnCount = self.serviceSupportResult.columnCount()
    #     list = []
    #     # rowCount = self.serviceSupportResult.rowCount()     #当前显示数据的表格的总行数
    #     # print(rowCount)
    #     # print(currentRow)
    #     # print(currentCloumnCount)
    #     # if currentRow-1 <= rowCount-2:
    #     #     for i in range(currentCloumnCount):
    #     #         item = self.serviceSupportResult.item(currentRow, i).text()
    #     #         # print(i)
    #     #         # print(item)
    ...
    #             list.append(item)
    #     data = list
    #     updateContentOfServiceSupport(data)
