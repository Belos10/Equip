...
from database.positionEngneerSql import selectAllDataAboutPosenginUnit
...
class AddPosenginUnitChoose(QDialog, Widget_AddUnitChoose):
    signal=QtCore.pyqtSignal(str)
    def __init__(self,parent=None):
        super(AddPosenginUnitChoose, self).__init__(parent)
        self.setupUi(self)
        self.signalConnect()
        self.unitAllList={}
    ...
    def getUsefulUnit(self,):
        self.unitDisturbList = selectAllDataAboutPosenginUnit()
    ...
    def getCreaseUnit(self):
        ...
        for i in self.tb_unitChoose.selectedRanges():
            print("i.topRow()",i.topRow(),"i.bottomRow()",i.bottomRow())
