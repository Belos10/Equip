...
from PyQt5.QtWidgets import QDialog, QApplication, QMessageBox, QFileDialog, QTableWidgetItem

from sysManage.maintainSupport.MaintanceContractSignSingleModel import MaintanceContractSignSingleModel
from sysManage.maintainSupport.MaintenanceContractSignTotalModel import MaintenanceContractSignTotalModel
...
class MaintenanceContractSignTransferModel(QDialog, Widget_Transfer_Model):
    signal=QtCore.pyqtSignal(str)
    def __init__(self, parent=None):
        super(MaintenanceContractSignTransferModel, self).__init__(parent)
        self.setupUi(self)
    ...
    def getUnitIDList(self, unitInfoList, equipInfo, year, requireInfo):
        ...
        self.totalModel = MaintenanceContractSignTotalModel()
        ...
        for unitInfo, num in zip(unitInfoList, requireInfo[2: -2]):
            if num == "" or num == "0":
                continue
            page = MaintanceContractSignSingleModel()
